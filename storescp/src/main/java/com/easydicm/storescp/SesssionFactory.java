...
public class SesssionFactory {
    private static final Logger LOG = LoggerFactory.getLogger(SesssionFactory.class);
    ...
    public boolean SessionRegister(String sessionUid) {
        SessionItem sessionItem = sessions.put(sessionUid, new SessionItem(sessionUid));
        return sessionItem.getMapBuffer() != null;
    }
